  ...
  return (
    <div style={{ padding: 12, fontFamily: "ui-sans-serif, system-ui" }}>
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none">  <div className="absolute left-[23.2031%] top-[0.0%] w-[6.3281%] h-[100.0%] overflow-hidden pointer-events-auto">    <Menufc7725 />  </div></div>
        </div>
