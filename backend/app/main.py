...
from backend.tasks.codegen import (  # noqa: E402
    integrate_figma_node,
...
# ── POST /figma-hook ──────────────────────────────────────────────────────
# Tar även emot "placement" från webview för bättre kontext i jobbet.
@app.post("/figma-hook")
...
async def task_cancel(task_id: str) -> Dict[str, Any]:
    try:
        # Avbryt och terminera om den kör. Celery rapporterar då REVOKED.
